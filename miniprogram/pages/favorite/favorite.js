   ...
   //刷新
    ...
    wx.getUserInfo({
      success: res => {
        ...
        // wx.cloud.database().collection(this.data.user_favorite).get().then(res=>{console.log(res)})
        wx.cloud.callFunction({
          name: "getFavorites",
          data: {
            collection: this.data.user_favorite
          ...
          success: res => {
            ...
            if (res.result.data.length == 0) {
              wx.cloud.database().collection(this.data.user_favorite).get().then(res => {
                result = res.data
              });
            } else {
      ...
      success: res => {
        ...
        wx.cloud.callFunction({
          ...
          success: res => {
            ...
            console.log(this.data.buttonLeft)
          }
        })
      }
    })
